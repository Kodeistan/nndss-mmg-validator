...
namespace Kodeistan.Mmg.Model
{
    ...
    public class DataElement
    {
        ...
        /// </summary>
        public Model.VADS.ValueSetWithConcept GetValueSet(MessageMappingGuide guide)
        {
            ...
            var valueSet = guide.ValueSets.Where(vs => vs.ValueSet.ValueSetCode == valueSetCode).FirstOrDefault();
            return valueSet;
        }
    }
